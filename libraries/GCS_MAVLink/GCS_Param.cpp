...
{
    if( strncmp(key, "VENDOR_PASS_1\0", std::max(strlen(key), strlen("VENDOR_PASS_1\0"))) == 0 || 
        strncmp(key, "VENDOR_PASS_2\0", std::max(strlen(key), strlen("VENDOR_PASS_2\0"))) == 0 || 
        strncmp(key, "VENDOR_PASS_3\0", std::max(strlen(key), strlen("VENDOR_PASS_3\0"))) == 0 || 
        strncmp(key, "VENDOR_PASS_4\0", std::max(strlen(key), strlen("VENDOR_PASS_4\0"))) == 0 || 
        strncmp(key, "VENDOR_PASS_5\0", std::max(strlen(key), strlen("VENDOR_PASS_5\0"))) == 0 )
    {
        return true;
    }
